...
* Jiang, L., Stapelfeldt, K., Pham, K., Richards, B. (2015). [The Learning in Neural Circuits Research Environment: Managing Living Specimens and Laboratory Data in Islandora](http://program.or2015.net/jiang-the_learning_in_neural_circuits_research_environment-108_a.pdf). *Open Repositories*, Indianapolis, Indiana.
